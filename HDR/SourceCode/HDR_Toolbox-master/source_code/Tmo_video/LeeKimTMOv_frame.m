function imgOut = LeeKimTMOv_frame(img, imgTmoPrev, fBeta, fLambda)
%
%       imgOut = LeeKimTMOv_frame(img, imgTmoPrev, fBeta, fLambda)
%
%
%       Input:
...
P_lum = log(lum(imgTmoPrev) + 1e-6);
divG = RemoveSpecials(dx + dy - fLambda * P_lum);
